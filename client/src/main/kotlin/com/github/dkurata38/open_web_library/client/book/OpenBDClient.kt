...
@Component
class OpenBDClient(private val restTemplate: RestTemplate) {
	companion object {
		private const val URI_TEMPLATE = "https://api.openbd.jp/v1/get?isbn=%s"
		val converter: (ISBN, BookSummaryResponse) -> BookSummary
			= { isbn: ISBN, bookSummaryResponse: BookSummaryResponse ->
